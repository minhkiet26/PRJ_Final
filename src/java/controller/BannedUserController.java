 ...
 * @author Admin
 */
@WebServlet(name = "BannedUserController", urlPatterns = {"/BannedUserController"})
public class BannedUserController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.getRequestDispatcher("bannedUser.jsp").forward(request, response);//chuyển trang
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
